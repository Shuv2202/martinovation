...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="relative py-24 sm:py-32 overflow-hidden bg-[#060913]">
      ...
      <div className="absolute top-1/3 left-10 w-96 h-96 bg-cyan-600/5 rounded-full blur-[140px] pointer-events-none -z-10" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-purple-600/5 rounded-full blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="font-orbitron text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">
            Engineering the <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-cyan-300 to-purple-400">Next Horizon</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              return (
                <button
                  ...
                  className={`text-left p-4 sm:p-5 rounded-2xl border transition-all duration-200 flex items-start gap-4 ${
                    isActive
                      ? 'bg-slate-900 border-cyan-400/80 shadow-[0_0_25px_rgba(0,240,255,0.2)] translate-x-1 sm:translate-x-2'
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 border ${
                      isActive
                        ? `bg-gradient-to-br ${pillar.color} text-black font-bold shadow-lg`
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="flex-1 p-6 sm:p-8 rounded-3xl bg-slate-900/90 border border-cyan-500/30 backdrop-blur-xl shadow-2xl flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="flex items-center gap-3">
                  <div className={`p-3 rounded-xl bg-gradient-to-br ${activePillar.color} text-black font-black shadow-lg`}>
                ...
                <div className="space-y-2.5 pt-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    {activePillar.highlights.map((item, idx) => (
                      <div
                        key={idx}
                        className="p-3 rounded-xl bg-slate-950/80 border border-slate-800 flex items-start gap-2.5 text-xs text-slate-200 font-inter"
                      >
              ...
              <div className="pt-6 mt-6 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4 relative z-10">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-orbitron font-bold uppercase tracking-wider text-cyan-400 hover:text-cyan-300 transition-colors"
                >
        ...
        <div className="mt-12 sm:mt-16 p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-slate-900/90 via-[#0a1122]/90 to-slate-900/90 border border-slate-800 flex flex-col lg:flex-row items-center justify-between gap-6 shadow-xl">
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs font-rajdhani tracking-wider text-cyan-300 uppercase shrink-0">
            <div className="flex items-center gap-1.5 bg-slate-950/80 px-3.5 py-2 rounded-lg border border-slate-800">
